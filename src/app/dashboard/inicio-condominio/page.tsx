...
import AdminDashboardCondominioClient from '@/components/dashboard/admin-dashboard-condominio-client'
import ResidentDashboardCondominioClient from '@/components/dashboard/resident-dashboard-condominio-client'
...
export default async function DashboardPage({
  ...
  if (!organization) {
    ...
    const buttonHref = isPropertyManager ? '/dashboard/propiedades' : '/onboarding'
  ...
  if (finalNextPaymentDate) {
    ...
    // Si no hay registro pero es administrador (como el pago de ayer), calculamos 30 días desde la creación
