                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="relative flex items-center justify-between">
                                        <div style={{ width: '32px', height: '32px', borderRadius: '9999px', backgroundColor: '#000000', border: '1px solid rgba(255,255,255,0.1)', position: 'absolute', left: '-16px' }} />
                                        <div style={{ width: '100%', height: '1px', borderTop: '1px dashed #3f3f46', margin: '0 16px' }} />
                                        <div style={{ width: '32px', height: '32px', borderRadius: '9999px', backgroundColor: '#000000', border: '1px solid rgba(255,255,255,0.1)', position: 'absolute', right: '-16px' }} />
                                    </div>
