...
async function run() {
    ...
    const { data: subs } = await supabase.from('subscriptions').select('*').eq('organization_id', orgId)
    console.log('SUBSCRIPTIONS FOR ORG cc123967-5f96-4d4e-acfa-0b4eb889b570:', subs)
}
