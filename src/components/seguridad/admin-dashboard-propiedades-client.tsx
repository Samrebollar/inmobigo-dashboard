    ...
    useEffect(() => {
        ...
        const fetchAll = async () => {
            try {
                ...
                console.error('Error fetching dashboard analytics (seguridad propiedades):', err)
                if (isMounted) {
        ...
        <div className="mx-auto max-w-7xl space-y-8 p-4 md:p-8">
            ...
            >
                ...
                <div className="pt-2">
                    ...
                    >
                        <Link href="/seguridad/morosos" className="block">
                            <motion.div variants={item} whileHover={{ y: -5 }}>
                        ...
                        <Link href="/seguridad/maintenance" className="block">
                            <motion.div variants={item} whileHover={{ y: -5 }}>
                        ...
                        <Link href="/seguridad/avisos" className="block">
                            <motion.div variants={item} whileHover={{ y: -5 }}>
                ...
                >
                    <Link href="/seguridad/propiedades">
                    ...
                    <Link href="/seguridad/configuracion">
                        <motion.div variants={item} whileHover={{ y: -5 }} className="h-full">
